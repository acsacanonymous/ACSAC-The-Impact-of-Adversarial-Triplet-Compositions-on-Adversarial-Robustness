...
def wideresnetwithswish(name, dataset='cifar10', num_classes=10):
    ...
    if 'cifar100' in dataset:
        print(f'Mean and std for cifar100')
        ...
        print(f'Mean and std for cifar10')
        return WideResNet(num_classes=num_classes, depth=depth, width=widen, activation_fn=_ACTIVATION[act_fn])
    else:
        print(f'Mean and std for Imagenet')
        return WideResNet(num_classes=num_classes, depth=depth, widen=widen, activation_fn=_ACTIVATION[act_fn],
