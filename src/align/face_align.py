...
if __name__ == '__main__':
    ...
    source_root = os.path.join(ROOT_DIR, "datasets/vggface2_test") # specify your source dir
    dest_root = os.path.join(ROOT_DIR, "datasets/vggface2_test_al") # specify your destination dir
    ...
    with torch.cuda.device(device):
        ...
        for i, subfolder in enumerate(tqdm(os.listdir(source_root))):
            ...
            for image_name in os.listdir(os.path.join(source_root, subfolder)):
                ...
                try: # Handle exception
                    _, landmarks = detect_faces(pnet, rnet, onet, img, device)
